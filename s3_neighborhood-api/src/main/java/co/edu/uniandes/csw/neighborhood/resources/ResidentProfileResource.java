...
public class ResidentProfileResource {
    ...
    @PUT
    @Path("{residentsId: \\d+}")
    public ResidentProfileDetailDTO updateAuthor(@PathParam("residentsId") Long residentsId, @PathParam("neighborhoodId") Long neighId, ResidentProfileDetailDTO resident) throws BusinessLogicException {
