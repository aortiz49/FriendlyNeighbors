...
public class CommentResource {
     ...
     *
     * @param comment {@link CommentDTO} - Comment to be persisted
     * @return JSON {@link CommentDTO} - Auto-generated comment to be persisted
     */
    @POST
    public CommentDTO createComment(CommentDTO comment) throws BusinessLogicException   {
    ...
    @GET
    @Path("{commentsId: \\d+}")
    public CommentDTO getComment(@PathParam("commentsId") Long commentsId) {
    ...
    @PUT
    @Path("{commentsId: \\d+}")
    public CommentDTO updateComment(@PathParam("commentsId") Long commentsId, CommentDTO comment) throws BusinessLogicException  {
    ...
    @DELETE
    @Path("{commentsId: \\d+}")
    public void deleteComment(@PathParam("commentsId") Long commentsId)  {
