...
public class ResidentLoginLogicTest {
    ...
    @Test
    public void createResidentLoginTest() {
        ...
        Assert.assertEquals(newResidentLogin.getGovernmentId(), entity.getGovernmentId());
        Assert.assertEquals(newResidentLogin.getPassword(), entity.getPassword());
