...
public class ResidentProfileLogicTest {
    ...
    public void createResidentTest() {
        ...
        try {
            ...
            Assert.assertEquals(newResident.getEmail(), entity.getEmail());
            Assert.assertEquals(newResident.getNickname(), entity.getNickname());
            Assert.assertEquals(newResident.getPhoneNumber(), entity.getPhoneNumber());
            Assert.assertEquals(newResident.getPreferences(), entity.getPreferences());
            Assert.assertEquals(newResident.getProofOfResidence(), entity.getProofOfResidence());
